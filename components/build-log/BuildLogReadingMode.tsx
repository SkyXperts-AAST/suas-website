...
export function BuildLogReadingSwitch() {
  ...
  return (
    <div className="pointer-events-none fixed bottom-4 right-4 z-[60] max-[380px]:bottom-3 max-[380px]:right-3 md:bottom-8 md:right-8">
      <div className="build-log-reading-switch pointer-events-auto rounded-full border p-1 shadow-[0_8px_32px_rgba(0,0,0,0.28)] backdrop-blur-md md:p-1.5">
        <button
          type="button"
          role="switch"
          ...
          className={`relative h-7 w-14 rounded-full border transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-transparent md:h-8 md:w-16 ${
            lightMode
